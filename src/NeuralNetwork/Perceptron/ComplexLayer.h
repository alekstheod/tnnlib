...
namespace nn {
    ...
    template < typename Perceptron > class ComplexLayer {
        public:
        ...
        template < typename VarType > using use = ComplexLayer< typename Perceptron::template use< VarType > >;

        /// @brief will rebind the number of inputs for an underlying perceptron
        template < std::size_t inputs > using resize = ComplexLayer< typename Perceptron::template resize< inputs > >;
