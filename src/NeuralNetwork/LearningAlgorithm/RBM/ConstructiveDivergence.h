...
namespace nn {
    ...
    namespace rbm {
        ...
        class ConstructiveDivergence {
          private:
            static_assert(PerceptronType::CONST_LAYERS_NUMBER == 2,
                          "Ivalid number of layers in a given perceptron.");
            using BepAlgo =
             bp::BepAlgorithm< typename PerceptronType::reverse::type, ErrorCalculator >;
            BepAlgo m_bepAlgo;
          ...
          public:
            using Prototype =
             std::tuple< std::array< Var, inputsNumber >, std::array< Var, outputsNumber > >;
          ...
          public:
            ...
            ConstructiveDivergence(Var learningRate, Var maxError)
             : m_bepAlgo(learningRate, maxError) {
            }
