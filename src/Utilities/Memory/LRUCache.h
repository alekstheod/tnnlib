...
namespace utils {
    ...
    template < typename KeyType, typename ValueType > class LRUCache {
        ...
        Iterator begin () {
            return boost::make_transform_iterator (m_lruList.begin (), boost::bind (&LRUCache::lruTransform, this, _1));
        }

        Iterator end () {
            return boost::make_transform_iterator (m_lruList.end (), boost::bind (&LRUCache::lruTransform, this, _1));
        }

        Iterator rbegin () {
            return boost::make_transform_iterator (m_lruList.rbegin (), boost::bind (&LRUCache::lruTransform, this, _1));
        }

        Iterator rend () {
            return boost::make_transform_iterator (m_lruList.rend (), boost::bind (&LRUCache::lruTransform, this, _1));
        }
        ...
        */
        template < typename Creator > ValueType read (KeyType key, Creator creator) {
         ...
         * @return cached or the new created value.
         */
        template < typename Creator, typename DropCallback > ValueType read (KeyType key, Creator creator, DropCallback drop) {
            ValueType result;
        ...
        template < typename DropCallback > void clear (DropCallback drop) {
