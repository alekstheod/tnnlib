...
#define USING_SUPPORT_TEST_T_NN(FIXTURE, TESTNAME, NAMESPACE, NESTED_NAMESPACE, CLASSNAME) class FIXTURE##_##TESTNAME##_Test;\
namespace NAMESPACE{  namespace NESTED_NAMESPACE{\
  template<>template<>void ::CLASSNAME::supportTest( FIXTURE##_##TESTNAME##_Test& test);\
}}
